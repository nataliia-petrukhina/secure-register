...
app.use(cors({credentials: true}))// Разрешаем кросс-доменные запросы (например, от фронтенда, который работает на другом порту). credentials: true — значит разрешаем куки и авторизацию.
